...
from_address = int(sys.argv[1], 16) if len(sys.argv)>1 else "REPLACE ME"
si_level_address = int(sys.argv[2], 16) if len(sys.argv)>2 else "REPLACE ME"
sol_file = sys.argv[3] if len(sys.argv)>3 else "/home/auditor/SI_ctf_levels/Lottery.sol"
gas = 100000
